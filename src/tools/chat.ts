...
export function registerChatTools(ctx: ServerContext) {
  ...
  return {
    tools,
    handlers: {
      chat_completion: withErrorHandler("chat_completion", handleChatCompletion),
      chat_with_preset: withErrorHandler("chat_with_preset", handleChatWithPreset),
      recommend_model: withErrorHandler("recommend_model", handleRecommendModel),
      optimize_prompt: withErrorHandler("optimize_prompt", handleOptimizePrompt),
      chat_ensemble: withErrorHandler("chat_ensemble", handleChatEnsemble),
      chat_routed: withErrorHandler("chat_routed", handleChatRouted),
    }
  };
